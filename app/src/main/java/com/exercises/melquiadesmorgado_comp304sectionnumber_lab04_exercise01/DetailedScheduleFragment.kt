...
class DetailedScheduleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_detailed_schedule, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment DetailedScheduleFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DetailedScheduleFragment().apply {
